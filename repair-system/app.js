                    ...
                    <div>
                        ...
                        >
                          ...
                          <optgroup lable="📚 แผนก">
                            ...
                            <option value="แผนกการจัดการสำนักงาน/การจัดการโลจิสติกส์และซัพพลายเชน">แผนกการจัดการสำนักงาน/การจัดการโลจิสติกส์และซัพพลายเชน</option>
                            <option value="แผนกดิจิทัลกราฟิก">แผนกดิจิทัลกราฟิก</option>
                            <option value="แผนกการท่องเที่ยว">แผนกการท่องเที่ยว</option>
                            <option value="แผนกการโรงแรม">แผนกการโรงแรม</option>
                            <option value="แผนกเทคโนโลยีธุรกิจดิจิทัล">แผนกเทคโนโลยีธุรกิจดิจิทัล</option>
                            <option value="แผนกสามัญ-สัมพันธ์">แผนกสามัญ-สัมพันธ์</option>
                            <option value="แผนกคหกรรมศาสตร์">แผนกคหกรรมศาสตร์</option>
                            <option value="แผนกอาหารและโภชนาการ">แผนกอาหารและโภชนาการ</option>
                            <option value="แผนกเทคโนโลยีแฟชั่นและเครื่องแต่งกาย">แผนกเทคโนโลยีแฟชั่นและเครื่องแต่งกาย</option>
                          </optgroup>
                          
                          <optgroup label="🏢 งาน">
                            <option value="งานประกันคุณภาพ">งานประกันคุณภาพ</option>
                            <option value="งานวัดผลและประเมินผล">งานวัดผลและประเมินผล</option>
                            <option value="งานพัฒนาหลักสูตรการเรียนการสอน">งานพัฒนาหลักสูตรการเรียนการสอน</option>
                            ...
                            <option value="งานกิจกรรมนักเรียน">งานกิจกรรมนักเรียน</option>
                            <option value="งานโครงการพิเศษ">งานโครงการพิเศษ</option>
                            <option value="งานอาชีวศึกษาระบบทวิภาคึ">งานอาชีวศึกษาระบบทวิภาคี</option>
                            <option value="งานวิทยบริการและห้องสมุด">งานวิทยบริการและห้องสมุด</option>
                            <option value="งานแนะแนวอาชีพและจัดหางาน">งานแนะแนวอาชีพและจัดหางาน</option>
                            <option value="งานส่งเสริมผลิตผลการค้าและประกอบธุรกิจ">งานส่งเสริมผลิตผลการค้าและประกอบธุรกิจ</option>
                            <option value="งานสวัสดิการนักเรียน นักศึกษา">งานสวัสดิการนักเรียน นักศึกษา</option>
                          </optgroup>
                        </select>
                      </div>
